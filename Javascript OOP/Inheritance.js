...
console.log(hourlyEmployee.getWage()); // Output: $5000 (base salary) + $200 (overtime) = $5200
console.log(salariedEmployee.getWage()); // Output: $5000 (base salary)